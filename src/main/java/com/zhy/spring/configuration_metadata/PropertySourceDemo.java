...
public class PropertySourceDemo {
    ...
    /**
     * user.name 是 Java Properties 默认存在，当前用户：user，而非配置文件中定义"zhy"
     *
     * @param id
     * @param name
     * @return
    ...
    public static void main(String[] args) {
        ...
        propertiesSource.put("user.name", "mask");
        org.springframework.core.env.PropertySource<Map<String, Object>> propertySource = new MapPropertySource("first-property-source", propertiesSource);
